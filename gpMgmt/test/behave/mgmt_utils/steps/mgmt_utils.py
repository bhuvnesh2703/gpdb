...
@given('generate an input cluster config file "{config_file}"')
def impl(context, config_file):
...
QD_PRIMARY_ARRAY=mdw:5432:{0}/data/master/gpseg-1:1:-1

declare -a PRIMARY_ARRAY=(
sdw1:1025:{0}/data/primary/gpseg0:2:0
sdw2:1026:{0}/data/primary/gpseg1:3:1
)

declare -a MIRROR_ARRAY=(
sdw2:1153:{0}/data/mirror/gpseg0:4:0
sdw1:1154:{0}/data/mirror/gpseg1:5:1
)
