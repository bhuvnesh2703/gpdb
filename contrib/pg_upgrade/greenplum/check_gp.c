...
check_foreign_key_constraints_on_root_partition(void)
{
	...
	if (found)
	{
		fclose(script);
		pg_log(PG_REPORT, "fatal\n");
		pg_fatal("Your installation contains foreign key constraint on root partition tables. These constraints \n"
